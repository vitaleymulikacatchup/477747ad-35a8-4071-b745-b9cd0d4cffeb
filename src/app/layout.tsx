...
export const metadata: Metadata = {
  title: "InCup Coffee Shop - Your Daily Brew of Happiness",  description: "Experience the finest coffee and delicious pastries at InCup, your local hub for quality brews and a cozy atmosphere.",  openGraph: {
    title: "InCup Coffee Shop",    description: "Experience the finest coffee and delicious pastries at InCup, your local hub for quality brews and a cozy atmosphere.",    url: "https://incup.com",    siteName: "InCup",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/crop-hand-holding-portafilter-with-coffee_23-2147830571.jpg",        alt: "Coffee beans and espresso machine"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "InCup Coffee Shop",    description: "Experience the finest coffee and delicious pastries at InCup, your local hub for quality brews and a cozy atmosphere.",    images: ["https://img.b2bpic.net/free-photo/crop-hand-holding-portafilter-with-coffee_23-2147830571.jpg"],
  },
};
